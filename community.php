    ...
    <body class="body bg-gradient-to-t from-gray-100 to-gray-100">
                ...
                <ol class=" inline-flex items-center  space-x-1 md:space-x-3">
                    <li>
                        <form action="" class="relative mx-auto w-max">
                            <input type="search" class="peer cursor-pointer relative z-10 h-10 w-11 rounded-full border bg-transparent pl-12 outline-none focus:w-full focus:cursor-text focus:border-grey-500 focus:pl-16 focus:pr-4" />
        ...
        <div class="content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
            ...
            <div class="container">
                ...
                <br />
                <div id="result" class="w-full md:w-2/3 mx-auto p-5 bg-white rounded-lg shadow">
                </div>
            </div>
