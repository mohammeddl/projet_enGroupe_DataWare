        ...
        <div class="max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
            ...
            <div>
                <form action="newpage.php" method="post">
                    ...
                    ?>
                    <?php
                    echo "<button type='submit' name='filterall'  class='flex  w-[80%] hover:ml-4 text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300' filterpro>All</button>";
                    while (mysqli_stmt_fetch($stmt)) {
                        echo "<div class='flex items-center space-x-3'>
                      <button type='submit' name='filterproj' value='$id' class='flex w-[80%] hover:ml-4 text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300' filterpro>$projetnom</button>
                  </div>";
                    }
                    ?>
                </form>
                ...
                <div>
                    <form class="w-full max-w-xl bg-white rounded-lg px-4 pt-2" method="post" action="">
                        <div class="flex flex-col flex-wrap -mx-3 mb-6">
                            ...
                            <div class="w-full md:w-full flex items-center justify-center p-4">
                                <div class="-mr-1">
                        ...
                        ?>
                                <div class="flex justify-between">
                                    <div class="flex">
                                        ...
                                        <input type="hidden" name="id_qst" value="<?php echo $row['id_qst']; ?>">
                                ...
                                <section>
                                    ...
                                    <div>
                                        ...
                                        $s = "SELECT id_rep, statut_rep, descrp_rep, date_rep,nom,prenom  FROM reponse inner join utilisateur on utilisateur.id = reponse.id_user inner join question on reponse.id_qst = question.id_qst WHERE question.id_qst = $idqst ORDER BY date_rep desc";
                                        ...
                                        ?>
                                                <div class="flex justify-between ">
                                                    ...
                                                    <div class="flex items-start mt-3 ml-14">
                                                        <div>
                                                            <button  class="inline-flex justify-center items-center w-6 h-6 rounded bg-gray-200 text-gray-800 font-medium text-sm cursor-pointer ">
                                                                ...
                                                                if( $r['statut_rep']== 1){
                                                                    ?>
                                                                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><path fill="#099f36" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
                                                        <?php   } else{
                                                            echo "D" ;
                                                        }
                                                           ?>
                                                    ...
                                                    <form class="flex gap-5" method="POST">
                                                        <input value="<?=$r["id_rep"]?>" name="id_rep" class="hidden">
                                                        <input value="<?=$r["statut_rep"]?>" name="statut_rep" class="hidden">
                                                        <button type="submit" name="submitArchiv"><svg class="h-5 w-5 text-red-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-2m-4-1v8m0 0l3-3m-3 3L9 8m-5 5h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293h3.172a1 1 0 00.707-.293l2.414-2.414a1 1 0 01.707-.293H20" />
                                                        </svg></button>

                                                        <button type="submit" name="submitModif"><svg class="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                        </svg></button>
                                        
                                                        <button type="submit" name="submitSolution" ><svg xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512"><path fill="#119c14" d="M96 80c0-26.5 21.5-48 48-48H432c26.5 0 48 21.5 48 48V384H96V80zm313 47c-9.4-9.4-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L409 161c9.4-9.4 9.4-24.6 0-33.9zM0 336c0-26.5 21.5-48 48-48H64V416H512V288h16c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V336z"/></svg>
                                                        
                                                        <button type="submit" name="submitDelete"><svg class="h-5 w-5 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                            <polyline points="3 6 5 6 21 6" />
                                                            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
                                                            <line x1="10" y1="11" x2="10" y2="17" />
                                                            <line x1="14" y1="11" x2="14" y2="17" />
