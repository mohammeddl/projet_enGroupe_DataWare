...
if ($row > 0) {
    ...
    while ($res = mysqli_fetch_array($fetch_query)) {
        if ($res['archive_qst'] == 0) {
            $idqst = $res['id_qst'];
            $iduser = $res['id_user'];
            $sql2 = "SELECT likee, dislike FROM reactions WHERE id_qst = $idqst";
        ...
        <div class='flex justify-between '>
            ...
            $output .= "<input type='hidden' name='id_user' id='id_user' value='$iduser'>";
        ...
        <button type='submit' name=''></svg></button></a>";
            ...
            $output .= $res2['likee'] ? $res2['likee'] : 0;
            $output .= "</span>
                            </div>
            ...
            $output .=  $res2['dislike'] ? $res2['dislike'] : 0;
            $output .= "</span>
                            </div>
        ...
        likebtn[i].addEventListener("click", e => {
            if (!requestSent) {
                ...
                console.log("Liked!");
                    ...
                    xhr.open("GET", "reactions.php?qstid=" + id + "&likes=" + likes + "&iduser=" + iduser + "&update="+update, true);
                    likebtn[i].style.backgroundColor = 'gray';
                console.log("Unliked!");
        ...
        dislikebtn[i].addEventListener("click", e => {
            if (!requestSent) {
                ...
                if(!clickedDislike){
                    ...
                    dislikes++;
                    xhr.open("GET", "reactions.php?qstid=" + id + "&dislikes=" + dislikes+ "&iduser=" + iduser + "&insert="+insert +"&type="+dis, true);
                    dislikebtn[i].style.backgroundColor = 'red';
            console.log("Liked!");
                }else{
                    ...
                    dislikebtn[i].style.backgroundColor = 'gray';
            console.log("Unliked!");
                }
