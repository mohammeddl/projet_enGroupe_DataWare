        ...
        likebtn[i].addEventListener("click", e => {
            if (!requestSent) {
                ...
                if(!clickedLikes){
                    ...
                    likes++;
                    xhr.open("GET", "reactions.php?qstid=" + id  + "&iduser=" + iduser , true);
                console.log("Liked!");
                
                // }else{
                //     clickedLikes = false;
                //     console.log(clickedLikes)
                //     likes--;
                //     console.log('decresslike : ',likes)
                //     xhr.open("GET", "reactions.php?qstid=" + id + "&likes=" + likes + "&iduser=" + iduser + "&update="+update, true);
                // console.log("Unliked!");
        ...
        dislikebtn[i].addEventListener("click", e => {
            if (!requestSent) {
                ...
                if(!clickedDislike){
                    ...
                    dislikes++;
                    xhr.open("GET", "reactions.php?qstid=" + id +  "&iduser=" + iduser +"&type="+dis, true);
            console.log("Liked!");
                }else{
                    ...
                    dislikes--;
                    xhr.open("GET", "reactions.php?qstid=" + id + "&dislikes=" + dislikes+ "&iduser=" + iduser + "&update="+update +"&type="+dis, true);
            console.log("Unliked!");
                }
