...
if($rowScrum['role'] == "ScrumMaster"){
        ...
        $output .= "</p>
                        ...
                        <div class='grid grid-cols-2 gap-4 md:flex md:items-center mt-4 mb-10 md:ml-12'>
                            <div class='flex md:items-center bg-gray-100  rounded-lg px-3 py-2 cursor-pointer group' id='likebtndiv' >
                                ...
                                <span class='text-sm text-gray-800  id='likebtn'>
                                    
                                </span>
                            </div>

                            <div class='flex md:items-center bg-gray-100  rounded-lg px-3 py-2 cursor-pointer group' id='dislikebtndiv' >
                                <svg class='mr-2 fill-current text-primary-black group-hover:text-primary' width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                ...
                                <span class='text-sm text-gray-800' id='dislikebtn'>
...
<script>
    const likebtn = document.getElementById('likebtndiv');
    const dislikebtn = document.getElementById('dislikebtndiv');
    const likebtnint = document.getElementById('likebtn');
    const dislikebtnint = document.getElementById('dislikebtn');
    let clicked = false;
